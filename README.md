...
*Fig.4: Count of **missed games** each season. [Figure notes: excluded events related to personal reasons, rest, or sickness; included only players averaging 10 minutes per game].*
...
*Fig.5: Count of **missed games due to serious injuries** each season. [Figure notes: excluded events related to personal reasons, rest, or sickness; included only players averaging 10 minutes per game].*
...
We can look at the number of games players are missing for rest each season and see how that has changed overtime. In Figure 11 we see a dramatic increase in games missed due to rest in 2015, 2016, and 2017, relative to prior seasons. 
