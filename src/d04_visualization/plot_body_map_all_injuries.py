...
#save path for plot
plot_savepath =  '../../results/01_plots/body_map_all_injuries{}.png'.format(year)
...
# text box two
ax.text(0.0001, 0.99, 'All Injury Durations', transform=ax.transAxes, fontsize=16, verticalalignment='top')   
