# -*- coding: utf-8 -*-
"""
This script creates a heat map showing the number of days missed due to injury
by month and year. Technically this plot shows the number of games missed due
...
#save path for plot
plot_savepath =  '../../results/01_plots/calendar_heatmap_all_injury.png'
#-------------------------Load Files------------------------------------------
...
r.set_title("Heatmap of Games Missed Due Injury", fontsize = 20, weight = 'bold')
