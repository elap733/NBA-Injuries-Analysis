...
#save path for plot
plot_savepath =  '../../results/01_plots/all_injury_body_map_{}.png'.format(year)
...
# text box two
ax.text(0.0001, 0.99, 'All Injuries Map', transform=ax.transAxes, fontsize=20, verticalalignment='top')   
