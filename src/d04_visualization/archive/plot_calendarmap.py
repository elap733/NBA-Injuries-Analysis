...
#save path for plot
#plot_savepath =  '../../results/01_plots/calendar_plot_serious_injury.png'


#save path for plot
plot_savepath =  '../../results/01_plots/calendar_plot_all_injury.png'
#-------------------------Load Files------------------------------------------
...
r.set_title("Heatmap of Games Missed Due Injury", fontsize = 20)
r.set_ylabel('Year', fontsize = 16)
r.set_xlabel('Month', fontsize = 16)
